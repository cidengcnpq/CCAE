...
#### Victor Higino Meneguitte Alves[^1], PhD candidate, Civil Engineer
...
[^2]: Orcid: [0000-0002-8860-1286](https://orcid.org/0000-0002-8860-1286)
...
`imagens_cwt_yellow_frame`

###  **● CWT input Images (Z24 Bridge)**
`Z24_Images_CWT_v1_MATLAB`
